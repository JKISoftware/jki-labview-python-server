...
<Project Type="Project" LVVersion="13008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="JKI_Python_Server Example 2 PyObjects 1 Event Structure.vi" Type="VI" URL="../JKI_Python_Server Example 2 PyObjects 1 Event Structure.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="TCP Server Connection Process Core__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Connection Process Core__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Connection Process Data Cluster__jki_lib_tcp_server.ctl" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Connection Process Data Cluster__jki_lib_tcp_server.ctl"/>
				<Item Name="TCP Server Connection Process__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Connection Process__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Connection Session ID Cluster__jki_lib_tcp_server.ctl" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Connection Session ID Cluster__jki_lib_tcp_server.ctl"/>
				<Item Name="TCP Server Create__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Create__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Data Core__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Data Core__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Data Store VI Name__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Data Store VI Name__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Data__jki_lib_tcp_server.ctl" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Data__jki_lib_tcp_server.ctl"/>
				<Item Name="TCP Server Default Data__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Default Data__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Delete__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Delete__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Destroy__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Destroy__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Get Connection Process VI Name__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Get Connection Process VI Name__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Get Connections Info__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Get Connections Info__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Get Data to Modify__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Get Data to Modify__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Get Data__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Get Data__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Get Instance Semaphore RefNum__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Get Instance Semaphore RefNum__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Get Listener Process VI Name__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Get Listener Process VI Name__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Handler RefNum__jki_lib_tcp_server.ctl" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Handler RefNum__jki_lib_tcp_server.ctl"/>
				<Item Name="TCP Server Launch Connection Process__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Launch Connection Process__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Launch Listener Process__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Launch Listener Process__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Listener Info Cluster__jki_lib_tcp_server.ctl" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Listener Info Cluster__jki_lib_tcp_server.ctl"/>
				<Item Name="TCP Server Listener Process Core__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Listener Process Core__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Listener Process__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Listener Process__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Lookup Connection Info by Instance VI__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Lookup Connection Info by Instance VI__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server New__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server New__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Object Data Core Task Enum__jki_lib_tcp_server.ctl" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Object Data Core Task Enum__jki_lib_tcp_server.ctl"/>
				<Item Name="TCP Server Object Data Store VI Ref Type__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Object Data Store VI Ref Type__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Object Data Store__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Object Data Store__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Object Ref Type__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Object Ref Type__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Object RefNum - Enum__jki_lib_tcp_server.ctl" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Object RefNum - Enum__jki_lib_tcp_server.ctl"/>
				<Item Name="TCP Server Object RefNum__jki_lib_tcp_server.ctl" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Object RefNum__jki_lib_tcp_server.ctl"/>
				<Item Name="TCP Server Open Object Reference__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Open Object Reference__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Public Connections Info Cluster__jki_lib_tcp_server.ctl" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Public Connections Info Cluster__jki_lib_tcp_server.ctl"/>
				<Item Name="TCP Server Register Connection Handler__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Register Connection Handler__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Search Connections for Connection__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Search Connections for Connection__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server Set Modified Data__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server Set Modified Data__jki_lib_tcp_server.vi"/>
				<Item Name="TCP Server UnRegister Connection Handler__jki_lib_tcp_server.vi" Type="VI" URL="/&lt;vilib&gt;/addons/_JKI.lib/_jki_lib_tcp_server.llb/TCP Server UnRegister Connection Handler__jki_lib_tcp_server.vi"/>
